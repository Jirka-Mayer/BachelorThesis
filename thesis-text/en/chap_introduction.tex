...
\begin{figure}[h]
    ...
    \caption{Comparison of a real-world image to an engraved image.}
    \label{fig1:Comparison}
    \medskip
    \small
    The top image is taken from the CVC-MUSCIMA dataset. The bottom image is the same music engraved using our engraving system and using symbols of the same writer.
\end{figure}
